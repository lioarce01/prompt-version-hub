...
export class AuthService {
  ...
  async register({
    ...
    // Note: A database trigger automatically creates the user record,
    // but we update the role here.
    // Workaround for TypeScript inference issue with @supabase/ssr client typing
